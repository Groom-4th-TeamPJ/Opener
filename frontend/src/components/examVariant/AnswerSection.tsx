            ...
            <label className="group flex items-center gap-3 cursor-pointer">
              ...
              >
                ...
                {!isSubmitted && isChecked && (
                  <Check className="absolute size-3 text-white opacity-100 scale-75 transition-all " />
                )}
                {/* 임시 아이콘 */}
                {isCorrectChecked && (
                  <CircleStop className="absolute size-3 text-white opacity-100 scale-75 transition-all " />
                )}
                {isWrongChecked && isChecked && (
                  <X className="absolute size-3 text-white opacity-100 scale-75 transition-all " />
                )}
              </span>
