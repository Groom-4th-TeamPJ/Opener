...
import ScrapRow from './ScrapBookListItem'
...
export default function ScrapBookList() {
  ...
  return (
    <div className="flex flex-col gap-9 min-h-dvh md:mt-14 lg:mt-27">
      ...
      <Card>
        <CardHeader className="pb-0">
          <div className="grid grid-cols-[1fr_3fr_1fr] gap-5 border-b border-b-neutral-600 p-3">
            <div>유형</div>
            <div>문제</div>
            <div>분석일시</div>
          </div>
